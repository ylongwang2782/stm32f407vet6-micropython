...
add_custom_command(
    ...
    COMMAND ${CMAKE_COMMAND} -E cat ${MICROPY_QSTRDEFS_PY} ${MICROPY_QSTRDEFS_PORT} ${MICROPY_QSTRDEFS_COLLECTED} > ${MICROPY_GENHDR_DIR}/qstr.temp
    COMMAND ${Python3_EXECUTABLE} ${MICROPY_PY_DIR}/qstr_preprocess.py step1 ${MICROPY_GENHDR_DIR}/qstr.temp ${MICROPY_GENHDR_DIR}/qstr.temp2
    COMMAND ${Python3_EXECUTABLE} ${MICROPY_PY_DIR}/run_gcc_preprocess.py ${MICROPY_GENHDR_DIR}/qstr.temp3 ${CMAKE_C_COMPILER} -E ${MICROPY_CPP_FLAGS} ${MICROPY_GENHDR_DIR}/qstr.temp2
    COMMAND ${Python3_EXECUTABLE} ${MICROPY_PY_DIR}/qstr_preprocess.py step2 ${MICROPY_GENHDR_DIR}/qstr.temp3 ${MICROPY_QSTRDEFS_PREPROCESSED}
    DEPENDS ${MICROPY_QSTRDEFS_PY}
        ${MICROPY_QSTRDEFS_PORT}
        ${MICROPY_QSTRDEFS_COLLECTED}
        ${MICROPY_PY_DIR}/qstr_preprocess.py
        ${MICROPY_PY_DIR}/run_gcc_preprocess.py
    VERBATIM
    COMMAND_EXPAND_LISTS
)
